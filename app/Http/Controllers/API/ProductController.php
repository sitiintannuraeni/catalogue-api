...
class ProductController extends Controller
{
    ...
    public function find($id)
    {
        ...
        return $this->prepareResponseGetProductById($product); // Wrap $product in array as we want to return a collection
    }
...
//        }
    ...
    private function prepareResponseGetProductById($product)
    {
        $mappedProductImages = collect($product->images)->map(function ($image) {
            return [
                'name' => $image['name'],
